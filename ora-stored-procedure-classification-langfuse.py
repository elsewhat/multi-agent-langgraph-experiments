...
langfuse_handler = CallbackHandler(
  secret_key="sk-lf-ed776604-4f49-4e75-99e3-7e8b1bc6fd7b",
  public_key="pk-lf-a5ccfa89-38f1-48b9-9279-b4e9761f37d9",
...
"""
result = tagging_chain.invoke({"oracle_plsql_storedprocedure": ORA_STORED_PROCEDURE_DEFINITION},config={"callbacks": [langfuse_handler]})
